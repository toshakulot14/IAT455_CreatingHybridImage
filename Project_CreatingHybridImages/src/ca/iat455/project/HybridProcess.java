 ...
 */
public class HybridProcess extends JFrame {
	...
	protected ArrayList<BufferedImage> createHybridImage(BufferedImage img1, BufferedImage img2, float[] filter, boolean showProcess) {
